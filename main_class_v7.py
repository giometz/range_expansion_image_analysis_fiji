...
class Range_Expansions():
	...
	def __init__(self):
		...
		self.command_to_folder['Edge Finder v2'] = self.edge_folder
		self.command_to_shortcut['Edge Finder v2'] = 'fe'
		...
		self.command_to_folder['doctor edges v3'] = self.edges_doctored_folder
		self.command_to_shortcut['doctor edges v3'] = 'de'
